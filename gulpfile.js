...
gulp.task("images", () => {
  return gulp
    .src("development/images/**/*", { encoding: false })
    .pipe(
...
gulp.task("vendorStyles", function () {
  return gulp
    .src(["development/css/**/*.css"], { allowEmpty: true })
    .pipe(plumber())
...
gulp.task(
  ...
  gulp.series(
    "clean",
    gulp.parallel("images", "vendorStyles", "styles", "scripts", "html")
  )
);
